...
public class TestFastDfs {
	...
	public void testUpload() throws Exception {
		...
		//2、加载配置文件
		ClientGlobal.init("D:/workspaces-itcast/JavaEE27/taotao-manager-web/src/main/resources/resource/client.conf");
	...
	public void testUploadByUtils() throws Exception {
		FastDFSClient fastDFSClient = new FastDFSClient("D:/workspaces-itcast/JavaEE27/taotao-manager-web/src/main/resources/resource/client.conf");
